...
export const REEDWAY_CHOICES = [
  {
    ...
    description: "Visit the clinic annex, worker landing and stranded barge. You can return to Lowsail and close your journey whenever you wish.",
  ...
  },
  {
    ...
    description: "Leave the settled pressure works to visit the shores between Blackglass and Lowsail. The return route remains open.",
    when: [{ type: "flag", flag: "blackglass-resolved", value: true }],
    effects: [{ type: "goTo", scene: "reedway-commons" }],
  },
  {
