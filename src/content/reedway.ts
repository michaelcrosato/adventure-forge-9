...
export const REEDWAY_CHOICES = [
  {
    ...
    description: "Visit the clinic annex, worker landing and stranded barge as a free, reversible part of this journey. You can return to Lowsail and finish whenever you wish.",
  ...
  },
  {
    ...
    description: "Visit the Reedway commons as a free, reversible part of this journey. You can return to Blackglass or Lowsail whenever you wish.",
    when: [{ type: "flag", flag: "blackglass-resolved", value: true }],
    effects: [{ type: "goTo", scene: "reedway-commons" }],
  },
  {
